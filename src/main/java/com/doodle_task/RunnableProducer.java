package com.doodle_task;

import com.doodle_task.com.datagen.invgen;
import com.doodle_task.types.PosInvoice;
...
public class RunnableProducer implements Runnable {
    ...
    private invgen invoiceGenerator;
    ...
    RunnableProducer(int id, KafkaProducer<String, PosInvoice> producer, String topicName, int produceSpeed) {
        ...
        this.invoiceGenerator = invgen.getInstance();
    }
    @Override
    public void run() {
        try {
